...
were confirmed by the report author. The other three planned pages are also accepted; the [final review](final_review.md) records completion of the four-page snapshot.
